...
# Azure Environment
export SUBSCRIPTION= 759cb5fd-7dea-4d05-97ae-725f450c93d8 # customize this
export RESOURCE_GROUP= NetworkWatcherRG # you may want to customize by supplying a Resource Group name
export WEBAPP= etmwebapp # customize this - say, seattle-petstore
export REGION=North Europe

export DATABASE_SERVER=javaeeapp # customize this
export DATABASE_ADMIN=Libosso # customize this
export DATABASE_ADMIN_PASSWORD=Tall@dmin. # customize this
...
# Composed secrets for Azure Monitor, Log Analtyics and Application Insight
